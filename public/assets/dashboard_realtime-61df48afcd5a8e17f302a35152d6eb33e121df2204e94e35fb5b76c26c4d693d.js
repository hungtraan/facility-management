...
*/
      ...
      if (!self.ispage || (!cap.cantouch && !cap.isieold && !cap.isie9mobile)) {
        ...
        if (self.opt.boxzoom&&!self.ispage&&!cap.isieold) {
          ...
          self.zoom = $(zoom);
          self.zoom.css({"cursor":"pointer",'z-index':self.zindex,'backgroundImage':"url('/assets/zoomico-4f805cf6c5c043779cf0cede80d242da5b2d9f0bff966670e45cebeeac558084.png')",'height':18,'width':18,'backgroundPosition':'0px 0px'});
